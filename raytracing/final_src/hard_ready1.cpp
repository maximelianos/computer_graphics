...
void main_wrapped(Image *img_ptr, int threads, int thr, float fov_h, float fov_v, int n_img, int m_img) {
	...
	/*read_poly(objects, "letters/letter-1-list.in", vec(-1, 2, -3), mat_x);
	read_poly(objects, "letters/letter-2-list.in", vec(2, 2, -3), mat_x);
	read_poly(objects, "letters/letter-3-list.in", vec(-3, -2, -3), mat_x);
	read_poly(objects, "letters/letter-4-list.in", vec(-1, -2, -3), mat_x);
	read_poly(objects, "letters/letter-5-list.in", vec(2, -2, -3), mat_x);*/
	
	//lights.push_back(Light(vec(1, 4, 0), vec(1, 1, 0.8)));
	//lights.push_back(Light(vec(2, 0.0, -0.2), vec(1, 1, 1)));
	//lights.push_back(Light(vec(0, 0.0, 1), vec(1, 1, 1)));
	//lights.push_back(Light(vec(-2, 0.0, -0.2), vec(1, 1, 1)));
